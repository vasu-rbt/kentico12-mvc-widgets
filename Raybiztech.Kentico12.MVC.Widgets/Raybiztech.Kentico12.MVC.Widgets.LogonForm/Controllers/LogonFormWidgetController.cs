...
[assembly: RegisterWidget("Raybiztech.Kentico12.MVC.Widgets.LogonForm", typeof(LogonFormWidgetController), "Logon form", Description = "Displays a form that allows users to log into the website. Authentication requires a valid username and password.", IconClass = "icon-user")]
